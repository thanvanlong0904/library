...
<div id="add-book">
    <div id="header-book" CLASS="text-center py-3">
        <h4 class="mb-0 py-2" style="background-color:#9200c8 ; color:white;  ">THÊM DANH MỤC</h4>
    </div>
    <div id="content-book" class="mt-3">
        <form class="row g-3"  action="{{route('book_category.craete')}}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="col-md-6">
            ...
            <div class="col-md-6">
                ...
                <input type="text" class="form-control" id="inputCity" name="not">
            </div>
