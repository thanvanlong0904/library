...
<div id="add-book">
    ...
    <div id="content-book" class="mt-3">
        <form class="row g-3"  action="{{route('member.create')}}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="col-md-6">
            ...
            <div class="col-md-6">
                ...
                <input type="phone" class="form-control" id="inputCity" name="phone">
            </div>
            <div class="col-md-6">
            ...
            <div class="col-md-6">
                ...
                <input type="number" class="form-control" id="inputZip" name="cccd">
            </div>
